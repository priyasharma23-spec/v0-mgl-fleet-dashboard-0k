...
export default function UserProfileView({ user, roleLabel, zone, region }: Props) {
    ...
    <div className="flex flex-col gap-5 p-5 max-w-2xl mx-auto">
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="px-4 py-3 bg-muted/30 border-b border-border flex items-center justify-between">
          ...
          <button
            onClick={() => { setShowChangePassword(!showChangePassword); setError("") }}
        ...
        {!showChangePassword ? (
          ...
          <div className="p-4 space-y-3">
            ...
            <button
              ...
              {saved ? <span className="flex items-center justify-center gap-2"><CheckCircle className="w-4 h-4" /> Password Updated</span> : "Update Password"}
            </button>
          </div>
        )}
      </div>

...
import { Upload, CheckCircle, Copy, RefreshCw, AlertCircle } from "lucide-react";
...
export default function MICRegisterFO({ onViewChange }: MICRegisterFOProps) {
  ...
  const [activationLink] = useState("https://mglfleet.in/activate?token=MGL-7X9K2P-2025");
        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <InputField label="GSTN Number" name="gstn" required />
        ...
        {step === 4 && !submitted && (
          <div className="space-y-4">
            ...
            <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-xs font-medium text-blue-700 mb-2">Activation Link (expires in 48 hours)</p>
              <div className="flex items-center gap-2">
                ...
                />
                <button onClick={copyLink} className="p-1.5 rounded bg-blue-100 hover:bg-blue-200 transition-colors text-blue-700">
